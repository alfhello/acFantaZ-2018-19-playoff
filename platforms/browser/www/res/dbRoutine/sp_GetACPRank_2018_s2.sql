...
inner join ascFanta_DailyValueRank_NBA_2018_s2 v on a.ascFanta_personID = v.ascFanta_pID
...
inner join ascFanta_DailyValueRank_NBA_2018_s2 v on a.ascFanta_pID = v.ascFanta_pID
